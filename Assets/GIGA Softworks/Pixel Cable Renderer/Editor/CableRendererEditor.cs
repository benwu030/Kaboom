...
namespace GIGA.PixelCableRenderer.Editor
{
	...
	public class CableRendererEditor : UnityEditor.Editor
	{
		...
		private void DrawHandles(CableRenderer renderer)
		{
			...
			var fmh_294_69_638490760319361140 = Quaternion.identity; Vector3 newModifierPos = Handles.FreeMoveHandle(prevModifierPos, size, Vector3.zero, CableRendererSettings.GetUnityHandle((CableRendererSettings.SupportedHandleType)EditorPrefs.GetInt(CableRendererSettings.SETTING_STRING_HANDLETYPE, 0)));
		...
		public static void DrawResizingHandles(CableRenderer renderer,bool hasDirection = false)
		{
			...
			var fmh_342_60_638490760319388220 = Quaternion.identity; Vector3 leftEdge = Handles.FreeMoveHandle(prevLeftEdge, size, snap, CableRendererSettings.GetUnityHandle((CableRendererSettings.SupportedHandleType)EditorPrefs.GetInt(CableRendererSettings.SETTING_STRING_HANDLETYPE, 0)));
			Handles.color = hasDirection ? Color.red : Color.green;
			var fmh_344_62_638490760319389880 = Quaternion.identity; Vector3 rightEdge = Handles.FreeMoveHandle(prevRightEdge, size, snap, CableRendererSettings.GetUnityHandle((CableRendererSettings.SupportedHandleType)EditorPrefs.GetInt(CableRendererSettings.SETTING_STRING_HANDLETYPE, 0)));
